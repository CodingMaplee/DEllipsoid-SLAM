...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        int SearchDynamicByBoW(KeyFrame* pKF,Frame &F, vector<MapPoint*> &vpMapPointMatches);
        ...
        int SearchByProjectionAllPoints(Frame &CurrentFrame, const std::vector<MapPoint*>& points, const float th , const int ORBdist);
