...
//__align__(16)
struct __attribute((aligned(16))) HashEntry 
{
...
//#define __CUDACC__
	...
	__device__  
		void exchangeVoxel(Voxel& v, Voxel& v1) const {
		v.color = v1.color;
		v.weight = v1.weight;
		v.sdf = v1.sdf;
        v.objectIndex = v1.objectIndex;
        v.catLabel = v1.catLabel;
	}
	__device__ 
		void exchangeVoxel(uint aim,uint id1) {
		exchangeVoxel(d_SDFBlocks[aim],d_SDFBlocks[id1]);
	}
