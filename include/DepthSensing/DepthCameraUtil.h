...
struct DepthCameraData {
    ...
    DepthCameraData(const float* depthData, const uchar4* colorData, const uchar* maskData, const uchar* personData) {//, const uint* catLabel
        d_depthData = depthData;
        d_colorData = colorData;
        d_maskData = maskData;
        d_personData = personData;
        d_objectData = NULL;
    }
    DepthCameraData(const float* depthData, const uchar4* colorData, const uchar* maskData, const uchar* personData, const uchar* objData) {//, const uint* catLabel
        d_depthData = depthData;
        d_colorData = colorData;
        d_maskData = maskData;
        d_personData = personData;
        d_objectData = objData;
    }
	//__host__
    ...
    const uchar*         d_maskData;
    const uchar*         d_personData;
    const uchar*         d_objectData;
    uint                 d_currFrameNumber;
