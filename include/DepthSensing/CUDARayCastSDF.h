...
public:
	...
	static RayCastParams parametersFromGlobalAppState(const GlobalAppState& gas, const Eigen::Matrix4f& intrinsics, const Eigen::Matrix4f& intrinsicsInv) {



        mat4f rayCastIntrinsics;
        rayCastIntrinsics.setIdentity();
        rayCastIntrinsics._m00 = intrinsics(0,0);
        rayCastIntrinsics._m01 = intrinsics(0,1);
        rayCastIntrinsics._m02 = intrinsics(0,2);
        rayCastIntrinsics._m03 = intrinsics(0,3);
        rayCastIntrinsics._m10 = intrinsics(1,0);
        rayCastIntrinsics._m11 = intrinsics(1,1);
        rayCastIntrinsics._m12 = intrinsics(1,2);
        rayCastIntrinsics._m13 = intrinsics(1,3);
        rayCastIntrinsics._m20 = intrinsics(2,0);
        rayCastIntrinsics._m21 = intrinsics(2,1);
        rayCastIntrinsics._m22 = intrinsics(2,2);
        rayCastIntrinsics._m23 = intrinsics(2,3);
        rayCastIntrinsics._m30 = intrinsics(3,0);
        rayCastIntrinsics._m31 = intrinsics(3,1);
        rayCastIntrinsics._m32 = intrinsics(3,2);
        rayCastIntrinsics._m33 = intrinsics(3,3);
