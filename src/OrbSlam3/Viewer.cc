...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuShowObjets("mens.show Objects", true,true);
    ...
    pangolin::Var<bool> menuCatCol("menu.Color by Cat", false, false);
    ...
    while(1)
    {
        ...
        //cv::imwrite("../wcg/"+to_string(mpSystem->curr_number)+".png",toShow);
        //cv::waitKey(mT);
